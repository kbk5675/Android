...
public class WriteMemoryRfid extends ToolbarManager implements RfidReaderEventListener,   View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_memory_rfid);
        ...
        //setToolbar("RFID READ (HEX)", this);

        setToolbar( getResources().getString(R.string.rfid_read_write) , this);
        //power 값 세팅
        /*
        try {
            /// write 할때는 일단 150으로
 ...
 */
    ...
    public void onReaderReadTag(ATRfidReader atRfidReader, String data, float v, float v1) {
        ...
        ATLog.e(TAG, "onReaderReadTag(%s, )", data);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (asciiFlag.equals("true")) {
                        editBarcode.setText( BcdUtilHelper.hexToString(data.substring(4))  );
                    }else {
                        editBarcode.setText(data.substring(4));
                    }
    ...
    public void barcodeReadData()
    {
        ...
        if ( (res = ApplicationClass.getmReader().readEpc6cTag() ) != ResultCode.NoError) {
